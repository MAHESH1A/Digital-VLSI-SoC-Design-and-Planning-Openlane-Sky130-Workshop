...
> Next: [Day 2 - Good Floorplan vs Bad Floorplan and Introduction to Library Cells](../Day 2_Good floorplan vs bad floorplan and introduction to library cells.md)
